...
var update = function (modifier) {
    ...
    if (timeLeft > 0) {
        if (dave.y > 0 && 38 in keysDown) { // Player holding up
        ...
        if (typeof (Storage) !== "undefined") {
            localStorage.score = monstersCaught;
        }
    }
};
...
var render = function () {
    ...
    document.getElementById("score").innerHTML = "<font size=+2><b>High Score is:</b> " + localStorage.score;
